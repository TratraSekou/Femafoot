...
export function DeleteMatchModal({ isOpen, onClose, onConfirm, match }: DeleteMatchModalProps) {
        ...
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Supprimer le match</h3>
                <p className="text-sm text-slate-400 mt-1">
                  Êtes-vous sûr de vouloir supprimer le match <span className="text-white font-semibold">{match.homeTeam.name} vs {match.awayTeam.name}</span> ? 
