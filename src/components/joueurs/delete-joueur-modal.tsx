...
interface DeleteJoueurModalProps {
  isOpen: boolean;
  onClose: () => void;
  onConfirm: () => void;
  joueur: Joueur | null;
...
export function DeleteJoueurModal({ isOpen, onClose, onConfirm, joueur }: DeleteJoueurModalProps) {
  if (!isOpen || !joueur) return null;
        ...
        <div className="p-6">
          <div className="flex items-start justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h3 className="text-lg font-bold text-white">Supprimer le joueur</h3>
                <p className="text-sm text-slate-400 mt-1">
                  Êtes-vous sûr de vouloir supprimer <span className="text-white font-semibold">{joueur.firstName} {joueur.lastName}</span> ? 
